...

{
    ...
    public function index()
    {
        ...
        $is_forbidden = request('is_forbidden') == 0 ? 0 : 1;
    ...
    public function store()
    {
        ...
        if(empty($coterie->memberWithTrashed) || $coterie->memberWithTrashed->is_forbidden==2){
            $status=true;
        }

        if ($coterie AND $coterie->cost_type == 'free' AND $status) {
    ...
    public function updateUserType()
    {
        ...
        if ($member AND $member->user_type != 'owner') {
            ...
            if($member_user_type=='guest' AND $member->user_type!='guest'){
    ...
    public function forbidden()
    {
        ...
        if ($member AND $member->user_type != 'owner') {
            ...
            $member->is_forbidden = request('is_forbidden') == 0 ? 0 : 1;
